...
#   Set up and run the optimisation algorithm 
if __name__ == "__main__":
    # Run optimisation over loan cohort
    ...
    loans.read_cohort(r"loans_test3.csv", r"write-off.csv")  # Import the loan cohort into the loan object
    ...
    optimum_price = dual_annealing(objective_function, bounds=bounds, x0=x0)
    ...
    #Print optimum and initial
    loans_initial = loans.repayment_profiles(x0)
    loans_optimum = loans.repayment_profiles(optimum_price.x)

    print('Initial Pricing', 'Interest Income:', loans_initial * -1)
    print('Optimum Pricing', 'Interest Income:', loans_optimum * -1)